...
public class CustomNetworkManager : NetworkBehaviour
{
    ...
    private void Start() {
        if (!playMultiplayer) {
            // Singleplayer
            StartHost();
            Loader.LoadNetwork(Loader.Scene.FreeForAll);
        }
    }
    ...
    private void NetworkManager_OnClientConnectedCallback(ulong clientId) {
        ...
        Debug.LogError($"Added {playerDataNetworkList.Count}");
...
*/
    ...
    public bool IsPlayerIndexConnected(int playerIndex) {
        Debug.LogError($"IsplayerIndexConnected {playerIndex } & { playerDataNetworkList.Count}");
